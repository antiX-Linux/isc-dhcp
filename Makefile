...
ACLOCAL = ${SHELL} /home/anticap/src-debs/src-debs-antix/stretch/isc-dhcp-4.3.5/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
ATF_CFLAGS = 
ATF_LDFLAGS = 
AUTOCONF = ${SHELL} /home/anticap/src-debs/src-debs-antix/stretch/isc-dhcp-4.3.5/missing autoconf
AUTOHEADER = ${SHELL} /home/anticap/src-debs/src-debs-antix/stretch/isc-dhcp-4.3.5/missing autoheader
AUTOMAKE = ${SHELL} /home/anticap/src-debs/src-debs-antix/stretch/isc-dhcp-4.3.5/missing automake-1.15
AWK = gawk
...
CFLAGS = -g -O2 -fdebug-prefix-map=/home/anticap/src-debs/src-debs-antix/stretch/isc-dhcp-4.3.5=. -fstack-protector-strong -Wformat -Werror=format-security -Wall -I/usr/include/bind-export -g -O2 -fdebug-prefix-map=/home/anticap/src-debs/src-debs-antix/stretch/isc-dhcp-4.3.5=. -fstack-protector-strong -Wformat -Werror=format-security -D_PATH_DHCPD_CONF='"/etc/dhcp/dhcpd.conf"' -D_PATH_DHCPD_DB='"/var/lib/dhcp/dhcpd.leases"' -D_PATH_DHCPD6_DB='"/var/lib/dhcp/dhcpd6.leases"' -D_PATH_DHCLIENT_SCRIPT='"/sbin/dhclient-script"' -D_PATH_DHCLIENT_CONF='"/etc/dhcp/dhclient.conf"' -D_PATH_DHCLIENT_DB='"/var/lib/dhcp/dhclient.leases"' -D_PATH_DHCLIENT6_DB='"/var/lib/dhcp/dhclient6.leases"' -DNSUPDATE  -I$(top_srcdir)/includes -I${top_srcdir}/bind/include
CPP = gcc -E
...
LDAP_CFLAGS = 
LDAP_LIBS = 
LDFLAGS = -lirs-export -Wl,-z,relro -Wl,-z,now
LIBOBJS = 
LIBS = 
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/anticap/src-debs/src-debs-antix/stretch/isc-dhcp-4.3.5/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = dhcp
PACKAGE_BUGREPORT = dhcp-users@isc.org
PACKAGE_NAME = DHCP
PACKAGE_STRING = DHCP 4.3.5
...
STRIP = 
VERSION = 4.3.5
abs_builddir = /home/anticap/src-debs/src-debs-antix/stretch/isc-dhcp-4.3.5
abs_srcdir = /home/anticap/src-debs/src-debs-antix/stretch/isc-dhcp-4.3.5
abs_top_builddir = /home/anticap/src-debs/src-debs-antix/stretch/isc-dhcp-4.3.5
abs_top_srcdir = /home/anticap/src-debs/src-debs-antix/stretch/isc-dhcp-4.3.5
ac_ct_CC = gcc
ac_prefix_program = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/anticap/src-debs/src-debs-antix/stretch/isc-dhcp-4.3.5/install-sh
